  ...
  return (
    <>
      ...
      <div className="stagger grid gap-4 sm:grid-cols-3">
        <Card className="p-5">
          <div className="text-sm text-slate-700">Total clients</div>
        ...
        <Card className="p-5">
          <div className="text-sm text-slate-700">Avg. risk</div>
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-slate-600">Sorted by risk</span>
      </div>
      ...
      <Card className="overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[760px] text-sm">
            <thead>
              <tr className="border-b border-[var(--border)] text-left text-xs uppercase tracking-wide text-slate-600">
