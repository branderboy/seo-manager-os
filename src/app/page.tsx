...
const PIPELINE = [
  ...
  { slug: "diagnosis", label: "04. Root Cause", name: "Diagnosis Engine", desc: "Determine the exact constraints holding back performance.", tone: "text-amber-600" },
  { slug: "strategy", label: "05. Plan", name: "Strategy Brief", desc: "Create the focused game plan designed to resolve the diagnosis.", tone: "text-amber-600" },
