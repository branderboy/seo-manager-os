...
export const workTasks: WorkTask[] = [
  ...
  { id: "w10", title: "Approve hero copy rewrite", client: "Hill Country Dental", owner: "Content lead", due: "Wed", priority: "Medium", step: "QA", lane: "Waiting on Content" },
  ...
  { id: "w12", title: "Fix NAP across 9 citations", client: "Northwind Heating & Air", owner: "Mia", due: "Today", priority: "Medium", step: "Complete", lane: "Active" },
