...
export const STAGES: Stage[] = [
  ...
  },
  {
    ...
    short: "Data",
    does: "Get access, then sync the client's data.",
    blurb: "Collect the client's access and credentials, then connect their data sources: Search Console, Analytics, GBP and the site crawl.",
    outputs: ["Access & credentials", "Search Console", "Analytics", "Google Business Profile", "Website crawl", "Rankings", "CRM"],
  ...
  },
  {
    ...
    name: "Reports",
    short: "Reports",
    does: "Track results, then start the next cycle.",
    blurb: "Track rankings, traffic, leads, calls, AI visibility and revenue against the goals set in Discovery, then feed the wins and gaps back into the next round of Insights.",
    outputs: ["Rankings", "Traffic", "Leads", "Calls", "AI Visibility", "Revenue Impact", "Performance Reports", "Next-cycle priorities"],
