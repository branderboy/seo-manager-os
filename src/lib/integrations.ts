...
export const integrations: Integration[] = [
  // Search & Analytics
  { id: "gbp", name: "Google Business Profile", blurb: "Profile, posts, reviews, Q&A and insights for every location.", category: "Local & Reviews", initials: "GB", color: "bg-blue-500", connected: true, account: "Northwind Heating & Air · 3 locations", synced: "2 minutes ago", metric: "3 locations syncing" },
  ...
  { id: "localfalcon", name: "Local Falcon", blurb: "Geo-grid rank scans across the service radius.", category: "Local & Reviews", initials: "LF", color: "bg-emerald-600", connected: true, account: "Northwind Heating & Air · 3 grids", synced: "Today, 6:00 AM", metric: "Geo-grid scans on" },

  // CRM & Leads
  { id: "hubspot", name: "HubSpot", blurb: "Sync leads, deals and revenue attribution.", category: "CRM & Leads", initials: "HS", color: "bg-orange-500", connected: true, account: "Northwind Heating & Air portal", synced: "1 hour ago", metric: "142 leads / 30d" },
  ...
  // SEO Data
  { id: "semrush", name: "Semrush", blurb: "Keyword, backlink and competitor data.", category: "SEO Data", initials: "SE", color: "bg-orange-600", connected: true, account: "Project: Northwind Heating & Air", synced: "Today, 6:00 AM", metric: "1,860 keywords" },
