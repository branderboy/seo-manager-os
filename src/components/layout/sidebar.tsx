...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-[240px] shrink-0 flex-col bg-[#333D49] lg:flex">
      <div className="sticky top-0 flex h-screen flex-col">
        ...
        >
          <div className="flex items-center gap-3 overflow-hidden">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-slate-400 font-bold text-white">
...
function NavLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="px-6 pb-1 pt-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-500">
      {children}
    </div>
  );
}
