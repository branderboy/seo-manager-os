      ...
      <div className="pointer-events-auto flex w-full max-w-3xl items-center gap-3 rounded-xl border border-[var(--border)] bg-white/95 px-3 py-2.5 shadow-lift backdrop-blur">
              ...
              >
                <span
                  className={cn(
                    ...
                    active
                      ? "border-2 border-accent-600 bg-accent-100 text-accent-700 ring-4 ring-accent-50"
                      : done
                        ? "border-2 border-accent-600 bg-accent-100 text-accent-700"
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          {prev && (
            <Link
              href={`/${prev.slug}`}
              className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-[var(--border)] text-slate-700 hover:bg-slate-50"
