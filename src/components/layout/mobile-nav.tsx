          ...
          <li key={it.href}>
            <Link
              ...
              className={cn(
                ...
                active ? "border-accent-500 bg-white/10 pl-5 font-medium text-white" : "border-transparent pl-6 text-slate-400 hover:bg-white/5 hover:text-white"
              )}
            >
              {typeof it.step === "number" ? (
                <span
                  className={cn(
                    ...
                    active ? "bg-accent-500 text-white" : "border-2 border-slate-500 text-slate-300"
                  )}
                >
                  {it.step}
                </span>
