...
import { Menu, X, Users, Workflow, LineChart, MapPin, Cloud, Building2, Plug, Settings } from "lucide-react";
          ...
          <li key={it.href}>
            <Link
              ...
              className={cn(
                ...
                active ? "border-[#51B34E] bg-white/10 pl-5 font-medium text-white" : "border-transparent pl-6 text-slate-400 hover:bg-white/5 hover:text-white"
              )}
            >
              {typeof it.step === "number" ? (
                <span
                  className={cn(
                    ...
                    active ? "bg-[#51B34E] text-white" : "border-2 border-slate-500 text-slate-300"
                  )}
                >
                  {it.step}
                </span>
